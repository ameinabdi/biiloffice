...
export class Config {
  ...
  'server.port' = '8081';
  'jhipster.clientApp.name' = 'BiilOffice';
  ...
  'jhipster.mail.from' = 'BiilOffice@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'BiilOffice API';
  'jhipster.swagger.description' = 'BiilOffice API documentation';
  ...
  'eureka.instance.appname' = 'BiilOffice';
  'eureka.instance.instanceId' = 'BiilOffice:${random.value}';
  ...
  'spring.cloud.config.name' = 'BiilOffice';
